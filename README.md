...
[Claude Code](docs/how-to-guides/using-vibium-with-claude-code.md),
[Grok Build](docs/how-to-guides/using-vibium-with-grok-build.md), and
[Claude Desktop Chat via MCP](docs/how-to-guides/using-vibium-with-claude-desktop.md).
On Linux, prefix, EEXIST, postinstall, and nightly installs are in
[Install the Vibium CLI on Linux](docs/how-to-guides/install-on-linux.md).
...
template). Vibium loads that file at start when it is mode 0600. See
