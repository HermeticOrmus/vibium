...
//
// Firefox records video from 154, which the release channel has carried since
// 2026-08-18, so this runs on release. VIBIUM_ENGINE_CHANNEL overrides.
...
const channel = process.env.VIBIUM_ENGINE_CHANNEL || "release";
